                ...
                \_ ->
                    let
                        getValue x =
                            case x of
                                ( a, b, c ) ->
                                    "a is " ++ toString a ++ " b is " ++ toString b ++ " c is " ++ toString c
                    in
            ...
            , test "use alias when destructuring record" <|
                \_ ->
                    let
                        ...
                        doSomething ({ x, y } as wholeRecord) =
                            toString x ++ toString y ++ toString wholeRecord.z
                    in
...
showPlayer p =
    "player name is " ++ .name p ++ " player id is " ++ toString (.id p)
...
showError e =
    case e of
        Message a i ->
            "Error code: " ++ toString i ++ toString a
